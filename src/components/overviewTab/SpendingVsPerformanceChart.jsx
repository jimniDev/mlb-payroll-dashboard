...
import { ScatterChart, Scatter, XAxis, YAxis, ZAxis, CartesianGrid, Tooltip, Cell, LabelList, ResponsiveContainer } from 'recharts';
import { formatPayroll } from '../../utils/formatters';

const SpendingVsPerformanceChart = ({ data }) => {
  return (
    <div className="bg-white p-4 rounded shadow-sm">
      <h3 className="text-lg font-medium mb-3 text-gray-700">Spending vs. Performance ({data[0]?.Year})</h3>
      <div className="h-96">
